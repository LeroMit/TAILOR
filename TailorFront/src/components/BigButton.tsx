...
import { LinearGradient as GradientBackground } from 'expo-linear-gradient'
...
const BigButton = ({ onPress, text, rotationInterpolation }) => {
  return (
          ...
          >
            ...
            >
              <LinearGradient id="grad" x1="0" y1="0" x2="1" y2="0">
                ...
                <Stop offset="1" stopColor="yellow" stopOpacity={0.5} />
              </LinearGradient>
